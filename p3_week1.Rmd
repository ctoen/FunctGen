...
5. colorize("Can interpret - and thus understand - ChIP- and DNaseI-seq signal in the UCSC genome browser.", "red")     
...
![](images/wk1_3_Furay_2012_naturereviews_fig2_chipseqanalysis.png){width=70%}\   
...
- How to go to a gene or region of interest.  
...
![](images/wk1_4b_ucsc_genome_browser_topmenubar.png){width=100%}   
...
![](images/wk1_4b_ucsc_gb_actb_question_startpage.png)  
...
![](images/wk1_4b_ucsc_gb_actb_locationinchromosome.png){width=100%}\     
<br>
...
![](images/wk1_4b_ucsc_gb_unselectsplicevariants.png)\    
<br>
Your GB session should look like this: ![](images/wk1_4b_ucsc_gb_actb_genetracksonly.png){width=100%}\      
<br>
...
![](images/wk1_4b_ucsc_gb_actb_geneinformation.png){width=100%}\    
<br>
...
![](images/wk1_4b_ucsc_gb_actb_question_TSSquestion.png)
...
```
<br>
```{r Q24_summary, eval = F, echo=T, exercise = T}
