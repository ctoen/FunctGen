...
[ChIP-seq by SatQuest](https://www.youtube.com/watch?v=nkWGmaYRues&ab_channel=StatQuestwithJoshStarmer)  
<br>  
...
```{r quiz_artefacts, echo =  T, eval = F}
