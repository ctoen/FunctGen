...
For this practical, we will use **data for white blood cells** from the [the ENCODE project](https://www.encodeproject.org/), namely: monocytes, T cells, B cells and natural killer cells. ENCODE is an ongoing, collaborative research effort to build a comprehensive list of functional elements in the human genome. We have chosen these datasets because they are well-documenten and easy to find through the ENCODE data portal, and not because we want to teach you the hematopoietic system.  
<br>  
...
## Need help?  
Use the virtual classroom space in Brightspace/Zoom meeting when you need advice. A teacher will be present there during practical hours.  
