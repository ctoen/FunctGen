...
<br>
`r colorize("Question asign what the name of the track with gene locations is or picutre with c/b/c/d/e/f etc. instead of track name and asking which one diplays the chromosomal coordinates and which one the gene locations?", "red")`  
...
<span style="color: orange; font-family: Arial; font-size:18px;">ACTION: Zoom out 3x and then another10x.</span>     
...
> `r colorize("UCSC GB session for the following exercises (tip: use right-mouse click to not loose this tutorial page): Monocyte wiggle & peak data, blueprint only: http://genome-euro.ucsc.edu/s/ctoenhake/hg38_monos_blueprint_and_encode/hg38_monos_blueprint_wiglle_and_peaks", "red")`    
...
question("Question 16: What is the approximate size of the H3K9me3 silenced region? (*Tip2: click-and-drag in the brwoser to capture and thereby measure the width of the H3K9me3 domain)",
  answer("250kb"),
  answer("500kb"),
...
question("Question 17: Which histone mark mediates repression of *ACTA1* in these cells?",
...
<br>
Our collegue performed ChIPs for H3K9me3, H3K27me3, H3K4me3, H3K36me3, H3K4me1 and H3K27ac using CD4+ T cells but accidently let the tubes fall before the tubes were properly labelled (always label your tubes first before adding your sample!). 
<br>
