...
<span style="color: red;"> Additional Ideas: </span>  
...
> UCSC GB sessions for making these exercises (tipo: use right-mouse click to not loose this tutorial page):  
>  
...
<br>
```{r Q2_ACTB_exons, eval = F, echo=T, class.source = "exercise"}
...
<br>     
```{r Q3_ACTB_start, eval = F, echo=T, class.source = "exercise"}
...
```{r Q4_ACTB_statements, eval = F, echo=T, class.source = "exercise"}
...
```{r Q5_spti, exercise =T, eval = F, exercise.eval=FALSE}
...
```{r Q6_ACTB_expression, eval = F, echo=T, class = "bg-warning"}
...
<br>
```{r Q7_ACTB_DNaseIseq, eval = F, echo=T, class = "bg-warning"}
...
```{r Q8_ACTB_histone_marks_one, eval = F, echo=T, class.source = "exercise"}
...
<br>
```{r Q9_peak_calling, eval = F, echo=T, class.source = "exercise"}
...
<br>
```{r Q10_FSCN1_bivalent_promoter, eval = F, echo=T}
...
<br>
```{r Q11_FSCN1_expression, eval = F, echo=T}
...
<br>
```{r Q12_ACTB_enhacer_one, eval = F, echo=T}
...
```
<br>
```{r Q13_ACTB_enhancer_two, eval = F, echo=T}
...
<br>
```{r cd14_questions, eval = F, echo=T, class.source = "exercise"}
...
```{r cd14_enhancer, eval = F, echo=T, class.source = "exercise"}
...
```{r cd14_near_silencing, eval = F, echo=T, class.source = "exercise"}
...
```
<br>
```{r cd14_near_silencing_two, eval = F, echo=T, class.source = "exercise"}
...
```{r Q9_ACTB_histone_marks_two, eval = F, echo=T, class.source = "exercise"}
