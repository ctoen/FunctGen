...
all_results <- read.table("/Users/christatoenhake/GitHub/FunctGen/data/blueprint/quantification/C000S5B1.gene_quantification.rsem_grape2_crg.GRCh38.20150622.results", header =T)
...
all_results$entrez_id = mapIds(org.Hs.eg.db,
...
quantification_chr19 <- all_results %>% filter(entrez_id %in% geneids_genes_chr19)
